...
00000000004019b5 <setval_424>:
  4019b5:	c7 07 54 c2 :58 92    	movl   $0x9258c254,(%rdi) #(58) pop  rax; xchg eax, edx = pop stack top to edx
  4019bb:	c3                   	retq   
...
0000000000401a03 <addval_190>:
  401a03:	8d 87 41 :48 89 e0    	lea    -0x1f76b7bf(%rdi),%eax # mov rax, rsp
  401a09:	c3                   	retq   
...
0000000000401a11 <addval_436>:
  401a11:	8d 87 :89 ce 90 90    	lea    -0x6f6f3177(%rdi),%eax % mov ecx to esi
  401a17:	c3                   	retq   
...
0000000000401a1e <addval_479>:
  401a1e:	8d 87 89 c2 00 c9    	lea    -0x36ff3d77(%rdi),%eax # mov eax to edx; pnop
  401a24:	c3                   	retq   

0000000000401a25 <addval_187>:
  401a25:	8d 87 89 ce 38 c0    	lea    -0x3fc73177(%rdi),%eax # mov ecx to esi; pnop
  401a2b:	c3                   	retq   
...
0000000000401a33 <getval_159>:
  401a33:	b8 :89 d1 38 c9       	mov    $0xc938d189,%eax # mov edx to ecx; pnop
  401a38:	c3                   	retq   

0000000000401a39 <addval_110>:
  401a39:	8d :87 c8 89 e0 c3    	lea    -0x3c1f7638(%rdi),%eax # xchg ecx,eax; mov esp to eax
  401a3f:	c3                   	retq   

0000000000401a40 <addval_487>:
  401a40:	8d 87 :89 c2 84 c0    	lea    -0x3f7b3d77(%rdi),%eax # mov eax to edx; pnop
  401a46:	c3                   	retq   
...
0000000000401a5a <setval_299>:
  401a5a:	c7 07 :48 89 e0 91    	movl   $0x91e08948,(%rdi) # mov rsp to rax; xchg ecx, eax
  401a60:	c3                   	retq   

0000000000401a61 <addval_404>:
  401a61:	8d 87 :89 ce 92 c3    	lea    -0x3c6d3177(%rdi),%eax # mov ecx, esi; xchg edx, eax
  401a67:	c3                   	retq   

0000000000401a68 <getval_311>:
  401a68:	b8 :89 d1 08 db       	mov    $0xdb08d189,%eax # mov edx, ecx
  401a6d:	c3                   	retq   

0000000000401a6e <setval_167>:
  401a6e:	c7 07 89 d1 :91 c3    	movl   $0xc391d189,(%rdi) # xchg ecx, eax
  401a74:	c3                   	retq   
...
0000000000401a83 <addval_358>:
  401a83:	8d :87 08 89 e0 90    	lea    -0x6f1f76f8(%rdi),%eax # xchg ecx, (rax); mov esp, eax
  401a89:	c3                   	retq   
